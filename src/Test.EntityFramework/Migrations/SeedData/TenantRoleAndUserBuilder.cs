...
namespace Test.Migrations.SeedData
{
    public class TenantRoleAndUserBuilder
    {
        ...
        private void CreateRolesAndUsers()
        {
            ...
            // phonebook
            // inserisce il record per eseguire gli unit test
            // person
            var person = _context.Persons.FirstOrDefault(p => p.Name == "David");
            if (person == null)
            {
                person = new CTC.Entities.Person();
                person.Name = "David";
                person.Surname = "Bandinelli";
                person.EmailAddress = "david.bandinelli@gmail.com";
                person.TelephoneNumber = "055123456";
                person.TipoContatto = Entities.Enums.TipiContatto.LAVORO;
                person.IsDeleted = false;
                person.CreationTime = System.DateTime.Now;
